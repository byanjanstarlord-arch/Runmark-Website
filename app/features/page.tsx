    ...
    <div className="py-12 md:py-20 bg-warm-grid">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg text-[#77736C] leading-relaxed">
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-[#77736C] leading-relaxed mb-5">
                    {feat.description}
                  </p>
                  ...
                  <div className="space-y-2 mb-6">
                    {feat.benefits.map((benefit, idx) => (
                      <div key={idx} className="flex items-start gap-2 text-xs text-[#202124]">
                ...
                <div className="pt-4 border-t border-[#E8E2D9] flex items-center justify-between">
                  {feat.command ? (
                    <code className="text-[11px] font-mono text-[#77736C] bg-[#FAF8F3] px-2.5 py-1 rounded-lg border border-[#E8E2D9] truncate max-w-[180px]">
                      {feat.command}
                    </code>
                  ) : (
                    <span className="text-xs text-[#77736C]">Architecture Concept</span>
                  )}
                  <Link
                    href={feat.docsUrl}
                    className="text-xs font-semibold text-[#FF5A1F] hover:text-[#E94D17] inline-flex items-center gap-1 transition-colors"
                  >
                    <span>Docs</span>
        ...
        <div className="rounded-3xl bg-[#FFFDF9] border border-[#E8E2D9] p-8 sm:p-12 shadow-warm-md mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            {/* Terminal Preview */}
            <div className="lg:col-span-6 rounded-2xl bg-[#17191C] border border-[#2A2E33] p-6 font-mono text-xs text-[#E6EDF3] overflow-x-auto shadow-warm-sm">
              <div className="flex items-center gap-2 pb-4 mb-4 border-b border-[#2A2E33]">
                <div className="w-2.5 h-2.5 rounded-full bg-[#FF5F56]" />
                <div className="w-2.5 h-2.5 rounded-full bg-[#FFBD2E]" />
                <div className="w-2.5 h-2.5 rounded-full bg-[#27C93F]" />
                <span className="text-[11px] text-[#77736C] ml-2">$ runmark scan</span>
              </div>
              <div className="space-y-1.5 leading-relaxed">
                ...
                <div className="text-white">Snapshot saved successfully.</div>
              </div>
            </div>
