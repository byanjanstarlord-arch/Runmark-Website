  ...
  return (
    <div className="py-12 md:py-20 bg-warm-grid min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="rounded-3xl bg-[#FFFDF9] border border-[#E8E2D9] p-8 sm:p-12 shadow-warm-sm space-y-5">
        ...
        <div className="rounded-3xl bg-[#FFFDF9] border border-[#E8E2D9] p-8 sm:p-12 shadow-warm-sm space-y-8">
          <div>
          ...
          <div className="pt-6 border-t border-[#E8E2D9] space-y-5">
            <h3 className="text-sm sm:text-base font-bold uppercase tracking-wider text-[#202124]">
              What We Believe
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="p-5 rounded-2xl bg-[#FAF8F3] border border-[#E8E2D9]">
                <h4 className="text-sm font-bold text-[#202124] mb-1.5">1. Environment Matters</h4>
              ...
              <div className="p-5 rounded-2xl bg-[#FAF8F3] border border-[#E8E2D9]">
                <h4 className="text-sm font-bold text-[#202124] mb-1.5">2. Local-First & Zero Secrets</h4>
                <p className="text-xs sm:text-sm text-[#77736C] leading-relaxed">
              ...
              <div className="p-5 rounded-2xl bg-[#FAF8F3] border border-[#E8E2D9]">
                <h4 className="text-sm font-bold text-[#202124] mb-1.5">3. Deterministic Facts</h4>
                <p className="text-xs sm:text-sm text-[#77736C] leading-relaxed">
              ...
              <div className="p-5 rounded-2xl bg-[#FAF8F3] border border-[#E8E2D9]">
                <h4 className="text-sm font-bold text-[#202124] mb-1.5">4. Open Source Collaboration</h4>
                <p className="text-xs sm:text-sm text-[#77736C] leading-relaxed">
